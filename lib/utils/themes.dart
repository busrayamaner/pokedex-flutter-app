...
class Themes {
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      primaryColor: const Color.fromRGBO(20, 21, 24, 1),
      backgroundColor: const Color.fromRGBO(20, 21, 24, 1),
      colorScheme: ColorScheme.light(
        primary: const Color.fromRGBO(20, 21, 24, 1),
        onPrimary: Colors.white,
      ...
      cardColor: const Color.fromRGBO(34, 35, 40, 1),
      splashColor: const Color.fromRGBO(20, 21, 24, 1),
      shadowColor: const Color.fromRGBO(20, 21, 24, 1),
      hintColor: Colors.grey,
